...
What is the class of the scientist column? Change it to factor and then show the levels of that factor. Changes scientist from a character into a factor.

A character is seeing things individually (ie: h-i)
A factor sees stuff as one thing (ie: hi)
```{r}
...
```
You can leave the data in the data folder and then say ::read_csv("data/Gaeta...etc")
