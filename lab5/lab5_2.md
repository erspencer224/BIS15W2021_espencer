...
**There are 37 good guys who are bald and 35 bad guys who are bald. There are more good guys who are bald not enough to show any statistical importance.**
...
## 8 Wolfsbane     473
```
**Number 10 only has 14 rows instead of 16 rows because the | operator allows us to include datapoints in the output that have either a height greater than 300 or a weight over 450. However, when this operator is used, you can also get datapoints that have heights greater than 300 and a weight over 450. In this case, there are 2 superheros that match both criteria of the | operator and therefore only 14 superheros are displayed.**
...
```r
superhero_powers <- rename(superhero_powers, accelerated_healing=accelerated_healing, durability="durability",super_strength="super_strength")
```
