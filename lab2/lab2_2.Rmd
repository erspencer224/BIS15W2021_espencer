...
## is.numeric(_)checks if the above vector is numeric ^
...
Box office earnings for Harry Potter movies (in millions!)for US, International. Notice that these are separate vectors. 
```{r}
